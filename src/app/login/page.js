...
export default function LoginPage() {
    ...
    return (
        ...
        >
            ...
            >
                <h2 style={{ textAlign: "center", marginBottom: "1rem",  color: "#333" }}>Connexion</h2>
                ...
                <p style={{ textAlign: "center", marginTop: "1rem",  color: "#333" }}>
                    Pas de compte ? <button onClick={() => router.push("/register")} style={{ color: "#007bff", cursor: "pointer", border: "none", background: "transparent" }}>S'inscrire</button>
                </p>
            </div>
        </div>
    )
